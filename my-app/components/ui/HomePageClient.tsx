...
const services = [
  {
    ...
    description:
      "A thorough exterior rinse and hand wash to remove salt, grime, and buildup from every outing.",
  },
  {
    title: "Full Detail Package (Most Popular)",
    description:
      "Our complete interior and exterior treatment, restoring your vessel to its best condition inside and out.",
  },
  {
    title: "Wax",
  ...
  },
  {
    ...
    description:
      "Deep cleaning of cabin, upholstery, carpets, and surfaces leaving the inside as sharp as the outside.",
  },
  {
    title: "Oxidation Removal",
    description:
      "We compound and polish away oxidation and faded gelcoat, bringing dull surfaces back to life.",
  },
  {
    title: "Monthly Maintenance",
    description:
      "Keep your boat in top shape year-round with a recurring maintenance plan tailored to your schedule.",
  },
];
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <Image
            ...
            alt="Marine detailing at the Jersey Shore"
            fill
