    ...
    <>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <p className="font-bold tracking-wider uppercase text-sm text-glow">
                Request Received!
              </p>
              <p className="text-white text-sm mt-1 leading-relaxed tracking-wide">
                Thank you for considering our services. We appreciate your interest and the
                opportunity to assist you. A member of our mobile detailing team will review your
                request and contact you shortly to discuss scheduling and availability.
              </p>
            </div>
            <button
              type="button"
      ...
      {submitStatus === "error" && (
        <div className="mb-8 rounded-2xl border border-red-500/40 bg-red-500/10 px-6 py-5 flex items-start gap-4">
          ...
          <div>
            <p className="font-bold tracking-wider uppercase text-sm text-red-400">
      ...
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs uppercase tracking-widest text-metallic font-semibold">
            Photo of Your Vessel{" "}
            <span className="normal-case tracking-normal text-metallic/50">(Optional)</span>
          </label>
          <label
            htmlFor="boatImage"
            ...
            {formData.boatImage ? (
              <>
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    setFormData((prev) => ({ ...prev, boatImage: null }));
                  }}
              ...
              <>
                ...
                >
                  ...
                  />
                  <path
                    d="M5 17a4 4 0 01-.5-7.95A5.5 5.5 0 1115.5 10h.5a3 3 0 010 6H5z"
                    stroke="currentColor"
                    strokeWidth="1.4"
                    strokeLinecap="round"
                  />
                </svg>
                <span className="text-sm text-metallic/60">
                  Click to upload a photo of your vessel
                </span>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-xs uppercase tracking-widest text-metallic font-semibold">
            Service Needed{" "}
            <span className="normal-case tracking-normal">(check all that apply)</span>
          </p>
